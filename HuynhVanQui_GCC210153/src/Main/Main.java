...
//    DefaultComboBoxModel cbModel = new DefaultComboBoxModel();
    ...
    private boolean loadFile(){
        ...
        /*
        vì chỗ này : load 2 file nhưng nó chỉ có load dc 1 file thoy, mà nó lại return true cho cả 2
        vậy em nên create 2 load file cho 2 file riêng
        */
    ...
    private void showDetail(int r){
     ...
     private void addFruit() {
        ...
        /*
    hôm trước cô nói là trong for chỉ dùng để duyệt, search
    giờ em muốn làm gì, idea sao
    em tạo 1 Object null của Fruit -> Fruit f = ....
    sau đó đi tìm trong fruit list bằng for, khi thấy dc cái em cần modify, em gán nó cho 
    break ra
    ngoài for, f.setQuan
     */
